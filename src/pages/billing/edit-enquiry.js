...
class EditEnquiry extends React.Component {
    render() {
        return (
            <div>
                {/* Breadcrumb */}
							...
							<div className="col-md-12 col-12">
								<nav aria-label="breadcrumb" className="page-breadcrumb">
									<ol className="breadcrumb">
										...
										<li className="breadcrumb-item active" aria-current="page">Edit Enquiry</li>
									</ol>
								</nav>
								<h2 className="breadcrumb-title">Edit Enquiry</h2>
							</div>
						</div>
					</div>
				</div>
                            ...
                            <div className="col-md-7 col-lg-8 col-xl-9">
								<div className="card">
									<div className="card-header">
										<h4 className="card-title mb-0">Edit Enquiry</h4>
									</div>
